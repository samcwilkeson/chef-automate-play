...
CHEF_SERVER_NAME="gamestop-ca-play" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="gamestop-ca-play-utropubhwvu9dtkg.eu-west-1.opsworks-cm.io" # The FQDN of your Chef Server
